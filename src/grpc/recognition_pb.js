...
proto.recognition.ModelsResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.recognition.ModelsResponse.repeatedFields_, null);
};
...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.recognition.StreamingRecognitionRequest.displayName = 'proto.recognition.StreamingRecognitionRequest';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
proto.recognition.StreamingRecognitionResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.recognition.StreamingRecognitionResponse.repeatedFields_, null);
};
...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.recognition.StreamingRecognitionResponse.displayName = 'proto.recognition.StreamingRecognitionResponse';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
modelsList: jspb.Message.toObjectList(msg.getModelsList(),
    proto.recognition.Model.toObject, includeInstance)
  };
...
proto.recognition.ModelsResponse.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      1,
      f,
      proto.recognition.Model.serializeBinaryToWriter
    );
  }
};
...
proto.recognition.ModelsResponse.prototype.addModels = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.recognition.Model, opt_index);
};
 ...
 * @return {!Object}
 */
proto.recognition.StreamingRecognitionRequest.prototype.toObject = function(opt_includeInstance) {
...
proto.recognition.StreamingRecognitionRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
config: (f = msg.getConfig()) && proto.recognition.RecognitionConfig.toObject(includeInstance, f),
...
proto.recognition.StreamingRecognitionRequest.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      1,
      f,
      proto.recognition.RecognitionConfig.serializeBinaryToWriter
    );
  }
 ...
 * @return {!Object}
 */
proto.recognition.StreamingRecognitionResponse.prototype.toObject = function(opt_includeInstance) {
...
chunksList: jspb.Message.toObjectList(msg.getChunksList(),
    proto.recognition.SpeechRecognitionChunk.toObject, includeInstance),
...
sentimentsInfo: (f = msg.getSentimentsInfo()) && proto.recognition.SentimentsInfo.toObject(includeInstance, f),
 ...
 * @return {!proto.recognition.StreamingRecognitionResponse}
 */
proto.recognition.StreamingRecognitionResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    case 1:
      ...
      reader.readMessage(value,proto.recognition.SpeechRecognitionChunk.deserializeBinaryFromReader);
      msg.addChunks(value);
      break;
    case 2:
      var value = /** @type {string} */ (reader.readString());
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.recognition.StreamingRecognitionResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  ...
  if (f != null) {
    writer.writeMessage(
      7,
      f,
      proto.recognition.SentimentsInfo.serializeBinaryToWriter
    );
  }
 ...
 */
proto.recognition.StreamingRecognitionResponse.prototype.addChunks = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.recognition.SpeechRecognitionChunk, opt_index);
};
